...
namespace TestGrafList
{
	public partial class Win_one
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget TestGrafList.Win_one
			this.Name = "TestGrafList.Win_one";
			this.Title = global::Mono.Unix.Catalog.GetString ("Window");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.DefaultWidth = 1000;
			this.DefaultHeight = 700;
			// Container child TestGrafList.Win_one.Gtk.Container+ContainerChild
